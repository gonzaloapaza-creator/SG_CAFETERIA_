...
public class frmFactura extends JFrame {
    ...
    private void inicializarComponentes() {
        JLabel lblTitulo = new JLabel("SISTEMA DE COBRANZA");
        ...
        JLabel lblBuscar = new JLabel("N° Recibo:");
        ...
        btnActualizar.setBounds(554, 515, 150, 35);
        ...
        btnCerrar.setBounds(730, 515, 120, 35);
